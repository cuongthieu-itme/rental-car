...
// Fix updateUserSchema to only require fields that client should send
const updateUserSchema = insertUserSchema
    ...
    .extend({
        // Make these fields optional with proper defaults
...
export const updateUser = async (
    userData: z.infer<typeof updateUserSchema> & {isNew?: boolean},
) => {
    const {id, clerk_id, isNew, ...safeUpdate} = userData;
    try {
        const updateData = {
            ...safeUpdate,
