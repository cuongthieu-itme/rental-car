...
import { useDeleteCar } from "@/features/cars/api/use-delete-car";
import { useDeleteCar as useDeleteCarModal } from "@/hooks/car/use-delete-car";

const DeleteCarDialog = () => {
  const { isOpen, onClose, id } = useDeleteCarModal();
